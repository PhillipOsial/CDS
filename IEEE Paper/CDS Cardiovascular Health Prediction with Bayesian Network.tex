...
Our research focused on two datasets. We first examined a dataset as seen in Table \ref{table_statlogheart}. 
\begin{table}[!ht]
\begin{center} 
\caption{Statlog Heart Data Set \cite{StatlogHeart}}
\begin{tabular}{ |P{0.3cm}|P{5.6cm}|P{1.5cm}| }
\hline
...
6 	&	Fasting Blood Sugar $>$ 120 mg/dl 									& fbs\\
 \hline
7 	&	Resting Electrocardiographic Results (Values 0,1,2) 					& recg\\
 \hline
8 	&	Maximum Heart Rate Achieved 										& mhr\\
 \hline
9 	&	Exercise Induced Angina 												& eia\\
 \hline
10 	&	Oldpeak = ST Depression Induced by Exercise Relative to Rest 		& op\\
 \hline
 11 &	The Slope of the Peak Exercise ST Segment 							& sop\\
 \hline
 12 &	Number of Major Vessels (0-3) Colored by Flourosopy 				& nmv\\
 \hline
 13 &	Thal: 3 = Normal; 6 = Fixed Defect; 7 = Reversible Defect 			& thal\\
 \hline
 14 &	Heart Disease Absent (1) or Present (2) 								& hdap\\
 \hline
\end{tabular}
